...
directorio" />
            ...
            <input type="text" name="nombre_directorio" id="nombre_directorio" placeholder="Nombre del directorio" /><br />
            </form>
            <?php
            ...
            echo $form;
            ?>
            <input type="image" name="mostrar" id="mostrar" src="img/folderopenfiles.jpg" alt="Mostrar directorio completo" />
