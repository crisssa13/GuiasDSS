...
class=\"ccform\">\n\t\t\t";
            ...
            <div class="ccfield-prepend">
                <input type="image" name="borrar" id="borrar" src="img/delete-file.gif" alt="Borrar archivo" class="ccimagefield" />
...
class=\"ccform\">\n\t\t\t";
            ...
            <div class="ccfield-prepend">
                ...
                <input type="text" name="destino" id="destino" placeholder="Nombre de la copia" required class="ccformfield" />
                <input type="image" name="copiar" id="copiar" src="img/copyfile.jpg" alt="Copiar archivo" class="ccimagefield" />
...
nombre" required class="ccformfield" />
                <input type="image" name="renombrar" id="renombrar" src="img/renamefile.png" alt="Renombrar archivo" class="ccimagefield" />
